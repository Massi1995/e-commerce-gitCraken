...
/* modification Massi 05/11/2020 */
define('_username_api_','VAP');
define('_password_api_','VAP');

define('_url_connexion_api_public_','https://apidev.cmp-paris.com:8543/authentication');
define('_url_connexion_api_interne_','https://rec-blueway2:8543/engine54/52/PortailJSON?flowName=API_BW_Authentification&flowType=EAII&actionJSON=launch');

define('_url_post_api_interne_','https://rec-blueway2:8543/engine54/52/PortailJSON?flowName=API_BW_Orders_Post&flowType=EAII&actionJSON=launch');
define('_url_post_api_public_','https://apidev.cmp-paris.com:8543/order/');

define('_url_get_orderStatus_public_PROD_','https://apidev.cmp-paris.com:8543/orderstatus/orderid/');
define('_url_get_orderStatus_public_DEV','https://rec-blueway2:8543/engine54/52/PortailJSON?flowName=API_BW_Orders_Status&flowType=EAII&actionJSON=launch&orderid=');
