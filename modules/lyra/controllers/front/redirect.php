    ...
    public function postProcess()
    {
        ...
        switch ($type) {
            ...
            case 'multi':
                ...
                $options = LyraMultiPayment::getAvailableOptions($cart);
            ...
            case 'oney':
                ...
                $options = LyraOneyPayment::getAvailableOptions($cart);
                $option = ' (' . $options[$data['opt']]['count'] . ' x)';
                break;
            ...
            case 'oney34':
                ...
                $options = LyraOney34Payment::getAvailableOptions($cart);
                $option = ' (' . $options[$data['opt']]['count'] . ' x)';
                break;
            ...
            case 'fullcb':
                ...
                $options = LyraFullcbPayment::getAvailableOptions($cart);
            ...
            case 'other':
                ...
                $label = Tools::getValue('lyra_payment_title');
