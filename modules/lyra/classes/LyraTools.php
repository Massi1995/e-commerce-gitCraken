...
class LyraTools
{
    ...
    public static $multi_lang_fields = array(
        ...
        'LYRA_STD_TITLE', 'LYRA_MULTI_TITLE', 'LYRA_ONEY_TITLE', 'LYRA_ONEY34_TITLE', 'LYRA_ANCV_TITLE',
        'LYRA_SEPA_TITLE', 'LYRA_SOFORT_TITLE', 'LYRA_PAYPAL_TITLE', 'LYRA_CHOOZEO_TITLE', 'LYRA_THEME_CONFIG',
        'LYRA_FULLCB_TITLE', 'LYRA_OTHER_TITLE'
    );
    ...
    public static $group_amount_fields = array(
        ...
        'LYRA_ONEY_AMOUNTS', 'LYRA_ONEY34_AMOUNTS', 'LYRA_SEPA_AMOUNTS',
        'LYRA_SOFORT_AMOUNTS', 'LYRA_PAYPAL_AMOUNTS', 'LYRA_CHOOZEO_AMOUNTS',
        'LYRA_CHOOZEO_OPTIONS', 'LYRA_FULLCB_AMOUNTS', 'LYRA_3DS_MIN_AMOUNT', 'LYRA_OTHER_AMOUNTS'
    );
    ...
    public static function getAdminParameters()
    {
        ...
        $params = array(
            ...
            array('key' => 'LYRA_STD_PROPOSE_ONEY', 'default' => 'False', 'label' => 'Propose FacilyPay Oney'),
            ...
            array('key' => 'LYRA_STD_REST_DISPLAY_MODE', 'default' => 'embedded', 'label' => 'Display mode'),
            ...
            array('key' => 'LYRA_ONEY_TITLE',
                ...
                'label' => 'Method title'),
            array('key' => 'LYRA_ONEY_ENABLED', 'default' => 'False', 'label' => 'Activation'),
            array('key' => 'LYRA_ONEY_DELAY', 'default' => '', 'label' => 'Capture delay'),
            array('key' => 'LYRA_ONEY_VALIDATION', 'default' => '-1', 'label' => 'Payment validation'),
            array('key' => 'LYRA_ONEY_AMOUNTS', 'default' => array(), 'label' => 'FacilyPay Oney payment - Customer group amount restriction'),
            array('key' => 'LYRA_ONEY_ENABLE_OPTIONS', 'default' => 'False',
                'label' => 'Enable options selection'),
            array('key' => 'LYRA_ONEY_OPTIONS', 'default' => array(), 'label' => 'FacilyPay Oney payment - Payment options'),
            ...
            array('key' => 'LYRA_ONEY34_ENABLE_OPTIONS', 'default' => 'False',
                'label' => 'Enable options selection'),
    ...
    public static function checkRestResult($response, $expectedStatuses = array())
    {
        ...
        if ($response['status'] !== 'SUCCESS') {
            ...
            $lyra = Module::getInstanceByName('lyra');
            throw new Exception(sprintf($lyra->l('Unexpected transaction type received (%s).'), $answer['detailedStatus']));
        }
    }
