...
class Ps_Socialfollow2 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->templateFile = 'module:Ps_Socialfollow2/Ps_Socialfollow2.tpl';
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('Ps_Socialfollow2'))) {
            $this->smarty->assign($this->getWidgetVariables($hookName, $configuration));
        }

        return $this->fetch($this->templateFile, $this->getCacheId('Ps_Socialfollow2'));
    }
